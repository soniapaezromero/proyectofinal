 ...
 */
class getCheckVerifiedUserSubscriberService extends App_KernelDewDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/EventSubscriber/CheckVerifiedUserSubscriber.php';
