...
class __TwigTemplate_eb0c60c244af773bb5b0a80f0e35b6a5 extends Template
{
    private $source;
    private $macros = [];
  ...
  <p></p>
    <table class=\"table\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["categorias"]) || array_key_exists("categorias", $context) ? $context["categorias"] : (function () { throw new RuntimeError('Variable "categorias" does not exist.', 18, $this->source); })()));
...
{% block body %}
  ...
  <p></p>
    ...
    <a class=\"btn btn-info w-25\" href=\"{{ path('app_categoria_new') }}\">Create new</a>
</div>
{% endblock %}
", "categoria/index.html.twig", "C:\\Users\\Pc\\Desktop\\proyecto del servidor\\StoreOnlineProject-master\\templates\\categoria\\index.html.twig");
    }
}
