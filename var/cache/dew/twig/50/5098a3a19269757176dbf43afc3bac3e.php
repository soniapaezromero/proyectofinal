...
class __TwigTemplate_fa6659e6e64970ee1925d37157944046 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  146 => 42,  141 => 39,  132 => 35,  121 => 29,  117 => 28,  113 => 27,  109 => 26,  104 => 24,  100 => 23,  96 => 21,  91 => 20,  75 => 6,  68 => 5,  54 => 3,  37 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\" style=\"width: 400px;\">
        ...
        {% for user in users %}
            ...
            <tr>
                <td><a href=\"{{ path('app_user_show', {'id':user.id}) }}\">Mostrar</a>
    ...
    <a href=\"{{ path('app_user_new') }}\">Crear</a>
</div>
{% endblock %}
", "user/index.html.twig", "/var/www/soniapaezromeroproyectofinal.online/public/StoreOnlineProject-master/templates/user/index.html.twig");
    }
}
