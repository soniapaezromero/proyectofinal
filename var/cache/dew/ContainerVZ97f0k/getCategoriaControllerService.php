...
class getCategoriaControllerService extends App_KernelDewDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Categoria'.\DIRECTORY_SEPARATOR.'CategoriaController.php';
