...
class __TwigTemplate_cfddb492b74e6c76200d88c348dd6047 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\" style=\"background: navajowhite;border: 0;\">
        ";
            // line 19
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "order", [], "any", false, false, false, 19), 'widget');
            yield "
        ";
            // line 20
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "total", [], "any", false, false, false, 20), 'widget');
            yield "
        ";
            // line 21
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "estado", [], "any", false, false, false, 21), 'widget');
            yield "
      <p></p>
       <p></p>
    ";
            // line 24
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "save", [], "any", false, false, false, 24), 'widget', ["attr" => ["class" => "btn btn-info w-25"]]);
            yield "
     <p></p>
     <p></p>
    ...
    <form  id=\"formElem\" name=\"formElem\" method=\"post\" href=\"";
        ...
        <div class=\"container\" style=\"background: navajowhite;border: 0;\">
            ...
            <label><h2>";
            // line 38
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["pedido"] ?? null), "referencia", [], "any", false, false, false, 38), "html", null, true);
            yield "</h2></label>
            <p></p>
            <p></p>
            ...
            <label><h5>";
            // line 43
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["pedido"] ?? null), "clientePedido", [], "any", false, false, false, 43), "html", null, true);
            yield "</h5></label>
            <p></p>
            ...
            // line 60
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(($context["productPedido"] ?? null));
            ...
            // line 76
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["pedido"] ?? null), "total", [], "any", false, false, false, 76), "html", null, true);
            ...
            // line 87
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::join(($context["productos"] ?? null), "|"), "html", null, true);
            ...
            yield "\">
                ...
                <p></p>
                    ";
            // line 151
            yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "save", [], "any", false, false, false, 151), 'widget', ["attr" => ["class" => "btn btn-info w-25"]]);
            yield "
                    <a class=\"btn btn-info w-25\" href=\"";
            // line 152
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_pedidocliente_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["cliente"] ?? null), "id", [], "any", false, false, false, 152)]), "html", null, true);
            yield "\">back to list</a>
                    ";
        }
        // line 154
    ...
    {
        return array (  388 => 197,  353 => 164,  345 => 163,  334 => 155,  329 => 154,  324 => 152,  320 => 151,  263 => 97,  256 => 92,  240 => 90,  236 => 89,  231 => 87,  217 => 76,  209 => 70,  199 => 66,  195 => 65,  191 => 64,  186 => 63,  182 => 62,  179 => 61,  175 => 60,  155 => 43,  147 => 38,  139 => 33,  134 => 32,  129 => 30,  123 => 27,  117 => 24,  111 => 21,  107 => 20,  103 => 19,  97 => 17,  94 => 16,  88 => 15,  76 => 9,  71 => 8,  66 => 7,  61 => 6,  57 => 5,  49 => 3,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "pedido/edit.html.twig", "/var/www/soniapaezromeroproyectofinal.online/public/StoreOnlineProject-master/templates/pedido/edit.html.twig");
    }
}
