...
class __TwigTemplate_c7f576f5e6faea733563460735a7a652 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-info w-25\">{{ button_label|default('Save') }}</button >
{{ form_end(form) }}
", "categoria/_form.html.twig", "/var/www/soniapaezromeroproyectofinal.online/public/StoreOnlineProject-master/templates/categoria/_form.html.twig");
    }
}
