...
class Stock extends \App\Entity\Stock implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Stock' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Stock' . "\0" . 'producto', '' . "\0" . 'App\\Entity\\Stock' . "\0" . 'cantidad'];
        }
     ...
     * {@inheritDoc}
     */
    public function setProducto(?\App\Entity\Producto $producto): \App\Entity\Stock
    {
