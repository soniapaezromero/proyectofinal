...
use App\Controller\Pedido\PedidoController;
...
class ProductoController extends AbstractController
{
     ...
     */
    public function new(Request $request, ProductoRepository $productoRepository,SluggerInterface $slugger, StockRepository $stockRepository): Response
    {
