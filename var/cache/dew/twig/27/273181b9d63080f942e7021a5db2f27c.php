...
/* user/show.html.twig */
class __TwigTemplate_d550facebdcae3c84b192ae8f7129659 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  132 => 40,  126 => 37,  120 => 34,  112 => 29,  105 => 25,  98 => 21,  91 => 17,  84 => 13,  75 => 6,  68 => 5,  54 => 3,  37 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
     ...
     <p>
    <a class=\"btn btn-info w-25\" href=\"{{ path('user_index') }}\">back to list</a>
   <p>
   <p>
    <a class=\"btn btn-info w-25\" href=\"{{ path('app_user_edit', {'id': user.id}) }}\">edit</a>
\t<p>
   <p>
    {{ include('user/_delete_form.html.twig') }}
    </div>
{% endblock %}
", "user/show.html.twig", "/var/www/soniapaezromeroproyectofinal.online/public/StoreOnlineProject-master/templates/user/show.html.twig");
    }
}
